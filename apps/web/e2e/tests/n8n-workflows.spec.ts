...
test.describe('N8N Workflow Integration', () => {
    ...
    test.describe('Error Handling', () => {
        ...
        test('should handle N8N timeout', async ({ page }) => {
            ...
            const timeoutMessage = page.locator(
                '[data-testid="timeout-message"], .timeout-message'
            );
    ...
    test.describe('Performance and Reliability', () => {
        ...
        test('should handle load testing scenario', async ({ page }) => {
            ...
            console.log(
                `Load test completed in ${totalTime}ms (${avgTimePerQuery.toFixed(2)}ms per query)`
            );
    ...
    test.describe('Business Logic Validation', () => {
        test('should route aviation queries to correct workflows', async ({ page }) => {
            ...
            const apolloResponse = page.locator(
                '[data-testid="chat-message"]:has-text("executive")'
            );
            const avinodeResponse = page.locator(
                '[data-testid="chat-message"]:has-text("aircraft")'
            );
        ...
        test('should validate workflow outputs', async ({ page }) => {
            ...
            const responseMessage = page.locator('[data-testid="chat-message"]').last();
            const metricsElements = responseMessage.locator(
                '[data-testid*="metric"], .metric, [class*="metric"]'
            );
