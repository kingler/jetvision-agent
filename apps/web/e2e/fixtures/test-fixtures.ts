...
export const AIRPORT_CODES = ['KJFK', 'KLAX', 'EGLL', 'LFPG', 'EDDF', 'RJTT', 'OMDB', 'YSSY'];
...
export const MOCK_N8N_RESPONSES = {
    ...
    general_response: {
        message:
            'I can help you with Apollo.io contact searches and Avinode aircraft bookings. What would you like to know?',
        status: 'success',
    },
};
