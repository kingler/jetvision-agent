                ...
                <div className="flex flex-col items-center justify-between gap-2 md:flex-row">
                    <div className="flex items-center gap-4">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-xs font-semibold text-gray-700 dark:text-gray-300">JetVision</span>
                        </div>
                        <div className="hidden md:flex items-center gap-2">
                            <IconShieldCheck size={14} className="text-gray-500" />
                            <span className="text-xs text-gray-600 dark:text-gray-400">ARG/US Platinum Rated</span>
                        </div>
                    </div>
